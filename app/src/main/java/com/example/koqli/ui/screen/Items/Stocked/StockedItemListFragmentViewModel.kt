 ...
 */
class StockedItemListFragmentViewModel(override val context: Context, val user: User): ViewModel {
    ...
    fun getItems(page: Int) {
        isLoading.set(true);
        application.usecases.getStockedItems(user.userIdentity.value, page, PerPage)
                .compose {
